...
export const subfamilia = {
  0: {
    ...
    columnDefs: [
      { headerName: "Subcategoría", field: "detalle_factura.sub_familia", valueGetter: p => p.data ? p.data["detalle_factura.sub_familia"] : '', enableRowGroup: true, filter: 'agSetColumnFilter', width: 200, pinned: 'left' },
