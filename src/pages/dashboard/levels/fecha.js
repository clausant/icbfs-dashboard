...
export const fecha = {
  0: {
    ...
    measures: ["detalle_factura.valor_neto_sum",
      ...
      "detalle_factura.producto_foco_valor_proyeccion",
    ...
    columnDefs: [
      ...
      { headerName: "PrecioUnit$", field: "detalle_factura.precio_unitario", valueGetter: p => p.data ? (Number(p.data["detalle_factura.precio_unitario"]) || 0) : 0, aggFunc: 'avg', enableValue: true, valueFormatter: p => currencyFormatter.format(p.value), width: 120, suppressHeaderMenuButton: true },
      ...
      { headerName: "MargenUnit$", field: "detalle_factura.margen_unitario", valueGetter: p => p.data ? (Number(p.data["detalle_factura.margen_unitario"]) || 0) : 0, aggFunc: 'avg', enableValue: true, valueFormatter: p => currencyFormatter.format(p.value), width: 120, suppressHeaderMenuButton: true },
      ...
      { headerName: "PFocoProy$", field: "detalle_factura.producto_foco_valor_proyeccion", valueGetter: p => p.data ? Number(p.data["detalle_factura.producto_foco_valor_proyeccion"]) : 0, aggFunc: 'sum', enableValue: true, valueFormatter: p => currencyFormatter.format(p.value), width: 120, suppressHeaderMenuButton: true },
      { headerName: "#Cliente", field: "detalle_factura.cliente_count", valueGetter: p => p.data ? Number(p.data["detalle_factura.cliente_count"]) : 0, aggFunc: 'sum', enableValue: true, valueFormatter: p => numberFormatter.format(p.value), width: 120, suppressHeaderMenuButton: true },
      ...
      { headerName: "#SKU/Cliente", field: "detalle_factura.ratio_sku_cliente", valueGetter: p => p.data ? Number(p.data["detalle_factura.ratio_sku_cliente"]) : 0, aggFunc: 'avg', enableValue: true, width: 120, suppressHeaderMenuButton: true },
