...
export const cliente = {
  0: {
    ...
    columnDefs: [
      { headerName: "Cliente", field: "detalle_factura.nombre_cliente", valueGetter: p => p.data ? p.data["detalle_factura.nombre_cliente"] : '', enableRowGroup: true, filter: 'agSetColumnFilter', width: 150, pinned: 'left' },
